...
module.exports = function(){
    ...
    it('mouseMove: 百度一下 ( #su, 47, 13 )', async function(){
        await driver.sleep(300).wait('#su', 30000)
               .sleep(300).mouseMove(47, 13);
    });

    it('expect: val, #su, equal, 百度一下', async function(){
        await driver.sleep(300).wait('#su', 30000)
            .val()
    ...
    it('insertVar: baidu ( #su, {{a}} )', async function(){
        await driver.sleep(300).wait('#su', 30000)
               .val(_(`{{a}}`));
    });

    it('eval: alert(\'baidu\')', async function(){
        await driver.eval(_('alert(\'baidu\')'));
    });
